...
export const setPlaybackDevice = async (
  accessToken: string,
  body: any
): Promise<void> => {
  const config = utils.getAxiosConfig({ accessToken });
...
export const setPlaybackPlay = async (accessToken: string): Promise<void> => {
  ...
  try {
    await axios.put(
      `${playerConfig.PLAYER_API_URI}/play`,
      new URLSearchParams({}),
      config
    );
  } catch (error) {
...
export const setPlaybackRepeat = async (
  accessToken: string,
  body: any
): Promise<void> => {
  const config = utils.getAxiosConfig({ accessToken });
  ...
  try {
    await axios.put(
      `${playerConfig.PLAYER_API_URI}/repeat${query}`,
      null,
      config
    );
  } catch (error) {
...
export const setPlaybackPrevious = async (
  accessToken: string
): Promise<void> => {
  const config = utils.getAxiosConfig({ accessToken });
...
export const setPlaybackSeek = async (
  accessToken: string,
  body: any
): Promise<void> => {
  const config = utils.getAxiosConfig({ accessToken });
  ...
  try {
    await axios.put(
      `${playerConfig.PLAYER_API_URI}/seek${query}`,
      null,
      config
    );
  } catch (error) {
...
export const setPlaybackShuffle = async (
  accessToken: string,
  body: any
): Promise<void> => {
  const config = utils.getAxiosConfig({ accessToken });
  ...
  try {
    await axios.put(
      `${playerConfig.PLAYER_API_URI}/shuffle${query}`,
      null,
      config
    );
  } catch (error) {
...
export const setPlaybackVolume = async (
  ...
  try {
    await axios.put(
      `${playerConfig.PLAYER_API_URI}/volume${query}`,
      null,
      config
    );
  } catch (error) {
...
export const getPlaybackDevices = async (
  ...
  try {
    const { data } = await axios.get(
      `${playerConfig.PLAYER_API_URI}/devices`,
      config
    );
    return data;
  } catch (error) {
